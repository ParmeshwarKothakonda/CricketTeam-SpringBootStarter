...
import com.example.player.Player; //Importing Player class
import com.example.player.PlayerRepository; //importing repository class
import java.util.*;
...
public class PlayerService implements PlayerRepository {
    ...
    private static HashMap<Integer, Player> team = new HashMap<>();  //sending the object Player as value to key
    int uniquePlayerId = 12;
    public PlayerService() { //constructor
    ...
    public Player updatePlayer(int playerId, Player player){
        Player exisitingPlayer = team.get(playerId);
